...
def main():
  ...
  ## optimizers
  optim_g = torch.optim.Adam(decoder.parameters(),lr=2e-4, betas=(0.5, 0.999), weight_decay=1e-2)
  optim_d = torch.optim.Adam(disciminator.parameters(),lr=2e-4, betas=(0.5, 0.999), weight_decay=1e-2)
  # optim_d = torch.optim.SGD(disciminator.parameters(),lr=2e-4, momentum=0.9, weight_decay=1e-3)
